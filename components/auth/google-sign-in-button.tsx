...
export function GoogleSignInButton() {
  ...
  return (
    <div className="space-y-2">
      <button
        type="button"
        className="flex h-13 w-full items-center justify-center gap-3 rounded-full bg-foreground px-6 text-base font-semibold text-white transition-colors hover:bg-[#2c2a26] active:scale-[0.99] disabled:opacity-50"
        disabled={loading}
